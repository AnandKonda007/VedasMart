...
public class Return_refund extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(Return_refund.this);
        checkNetwork();
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.home) {
                    progressDialog.show();
                    startActivity(new Intent(Return_refund.this, DashBoard.class));
                    progressDialog.dismiss();

                }
                else if (id == R.id.terms_and_conditions) {
                    progressDialog.show();
                    startActivity(new Intent(Return_refund.this, Terms_and_conditions.class));
                    progressDialog.dismiss();
                  ...
                  drawerLayout.openDrawer(GravityCompat.START);
                    ...
                    progressDialog.show();
                    startActivity(new Intent(Return_refund.this, Faq.class));
                    progressDialog.dismiss();
    ...
    private void webActions() {
        webView = findViewById(R.id.web_return_refund);
        Log.e("Webview", "calling webview page");
        webView.getSettings().setJavaScriptEnabled(true);
        webView.loadUrl("file:///android_asset/ReturnAndRefunds.htm");
        progressDialog.dismiss();

        //directly we load url below
        //webView.loadUrl("http://liveapi-vmart.softexer.com/ReturnAndRefunds.htm");
